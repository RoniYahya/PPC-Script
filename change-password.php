...
$template->loadTemplate("common-templates/change-password.tpl.html");
...
$form=new Form("EditPassword","change-password-action.php");
...
$template->setValue("{SUBMIT}",$form->addSubmit($template->checkComMsg(1029)));
