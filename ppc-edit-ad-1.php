...
if($adult_status==1)
{
$template->setValue("{ADULT}","<input type="radio" name="adult_status" value="0" id="adult_status_no"> &nbsp;
                   Yes&nbsp;<input type="radio" name="adult_status" value="1" id="adult_status_yes" checked="checked">");
}
else
{
$template->setValue("{ADULT}","<input type="radio" name="adult_status" value="0" id="adult_status_no" checked="checked"> &nbsp;
