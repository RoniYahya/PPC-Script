...
function scrollDownSub()
{
	if(divToScroll){
		...
		if(height<ulToScroll.offsetHeight)setTimeout('scrollDownSub()',30); else {
			divToScroll = false;
			ulToScroll = false;
...
function initSlideDownMenu(initid)
{
	document.getElementById('dhtmlgoodies_slidedown_menu').style.display='block';
	if(initid > -1)
		initMenuIdToExpand='mainMenuItem'+(initid+1);
//		alert(initid);
