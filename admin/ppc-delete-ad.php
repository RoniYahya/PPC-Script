...
<form action="ppc-delete-ad-action.php" method="post" enctype="multipart/form-data" name="form1">
...
<tr>
  <td><input name="send_mail" type="checkbox" id="send_mail" value="1" checked>
  Send email notification   <?php
  if($script_mode=="demo")
 {
