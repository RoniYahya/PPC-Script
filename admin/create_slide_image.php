...
function check_value()
				{
					...
					var img=document.getElementById('ad_logos').value;
	if(img!="")
	{
...
<form name="form1" method="post" action="create_slide_image_action.php" enctype="multipart/form-data" >
  ...
  <tr>
    ...
    <tr >
      <td height="65" colspan="3" scope="row" class="heading">Create New Public Slide Image </td>
    </tr>
    ...
    <!--<tr>
      ...
      <td colspan="2"><label>
        <input type="text" name="name" id="name"> <span class="style1 style10"><strong><font color="red">*</font></strong></span>
      </label></td>
    </tr>-->
    <tr>
      <td height="27">&nbsp;</td>
    ...
    <tr>
      <td height="27" valign="top">Upload Image</td>
      ...
      <?php $path=$GLOBALS['logo_path'];?><br><span class="note">( Max size is 750 x 250 . Please use gif/jpg/png files) </span>      <br />
&nbsp;</td>
    </tr>
    <tr>
      <td height="27">&nbsp;</td>
    ...
    <tr>
      ...
      <th colspan="2" align="left" scope="row"><input type="submit" name="Submit" value="Upload!" onclick="return check_value()"></th>
    </tr>
  </table>
</form>
