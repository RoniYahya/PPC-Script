...
else
{
	...
	//include("../".$classpath."class.User.php");//echo "../".$classpath."class.User.php";
	include("../".$GLOBALS['classes_folder']."/class.User.php");
...
.tb2, .tb3, .tb4 {background:<?php if($row['credit_text_positioning']==1 && $row['ctext'] !=0) echo $r1[2]; else echo $row['bg_color']; ?>; border-left:1px solid <?php echo $r1[2]; ?>; border-right:1px solid <?php echo $r1[2]; ?>;}
...
.bb2, .bb3, .bb4 {background:<?php if($row['credit_text_positioning']==0 && $row['ctext'] !=0) echo $r1[2];  else echo  $row['bg_color']; ?>; border-left:1px solid <?php echo $r1[2]; ?>; border-right:1px solid <?php echo $r1[2]; ?>;}
...
?>
		...
		font-size:<?php echo $row['title_size'];?>px;
...
if($row['ad_type']==2 || $type=="image")
{
		...
		//if($row['credit_text_positioning']==1 && $row['ctext'] !=0)
		...
		if($row['credit_text_positioning']==1 && $row['ctext']!=0)  
				...
				<li class="liclass"  ><div id="idiv" class="inout_credit_over">(i)</div><div class="inout_credit_data"   id="crd"  ><table cellpadding="0" cellspacing="0" class="inout-before-credit"><?php echo  $credittextpreview;?></table></div></li>
		...
		<?php
		if($row['credit_text_positioning']==0 && $row['ctext']!=0)  
				{
				?>  
				<li class="liclass"  ><div id="idiv" class="inout_credit_over">(i)</div><div class="inout_credit_data"   id="crd"  ><table cellpadding="0" cellspacing="0" class="inout-before-credit"><?php echo  $credittextpreview;?></table></div></li>
	...
	//	echo $catalog_width."dddddddd".$row[41];
		if($row['orientaion']==2)//horizontal
			...
			//echo $catalog_width."ssss";
				...
				?><tr><?php
					...
					if($row['catalog_alignment']==1)
					 { 
					 ?><table cellpadding="5" cellspacing="0" height="100%" border=0  style="line-height: <?php echo $row['line_height']; ?>px;table-layout:fixed;overflow:hidden;<?php if($row['catalog_line_seperator']==1 && $i < $row['no_of_catalog_ads']-1 ){ ?>border-right:solid 1px <?php echo $r1[2]; ?>; <?php } ?>"><tr><td align="center" style="width:<?php echo $catalog_width; ?>px;vertical-align:top;"><div style="height:<?php echo $catalog_height; ?>px;width:<?php echo $catalog_width; ?>px;background: url(../images/banner.gif) repeat; "></div></td><td align="left" valign="top"><div class="inout-title"><a href="#" target="_blank"><?php echo $ad_title; ?></a></div><div class="inout-desc"><?php echo $d_description; ?></div></td></tr></table><?php 
					 } else 
					 {
					  ?><table cellpadding="5" height="100%" cellspacing="0" border=0  style="line-height: <?php echo $row['line_height']; ?>px;table-layout:fixed;overflow:hidden;<?php if($row['catalog_line_seperator']==1 && $i < $row['no_of_catalog_ads']-1) { ?> border-right:solid 1px <?php echo $r1[2]; ?>; <?php } ?>"><tr><td align="center" style="height:<?php echo $catalog_height; ?>px;vertical-align:top;"><div style="height:<?php echo $catalog_height; ?>px;width:<?php echo $catalog_width; ?>px;background: url(../images/banner.gif) repeat; "></div></td></tr><tr><td valign="top"><div class="inout-title"><a href="#" target="_blank"><?php echo $ad_title; ?></a></div><div class="inout-desc"><?php echo $d_description; ?></div></td></tr></table><?php 
					  } 
					  ?></td><?php
					   }
					   ?></tr><?php 
		...
		else //vertical
			{
				...
				if($row['catalog_alignment']==1) 
				{ 
				?><table  cellpadding="5"  cellspacing="0" border=0  style="line-height: <?php echo $row['line_height']; ?>px;table-layout:fixed;overflow:hidden;<?php if($row['catalog_line_seperator']==1  && $i < $row['no_of_catalog_ads']-1) { ?> border-bottom:solid 1px <?php echo $r1[2]; ?>;<?php } ?>"><tr><td align="center" style="width:<?php echo $catalog_width; ?>px;vertical-align:top;"><div style=" height:<?php echo $catalog_height; ?>px;width:<?php echo $catalog_width; ?>px;background: url(../images/banner.gif) repeat; "></div></td><td align="left" valign="top"><div class="inout-title"><a href="#" target="_blank"><?php echo $ad_title; ?></a></div><div class="inout-desc"><?php echo $d_description; ?></div></td></tr></table><?php 
				} 
				else 
				{ 
				?><table cellpadding="5"  cellspacing="0" border=0 style="line-height: <?php echo $row['line_height']; ?>px;table-layout:fixed;overflow:hidden;<?php if($row['catalog_line_seperator']==1  && $i < $row['no_of_catalog_ads']-1) { ?> border-bottom:solid 1px <?php echo $r1[2]; ?>; <?php } ?>"><tr><td align="center" style="height:<?php echo $catalog_height; ?>px;vertical-align:top;"><div style="height:<?php echo $catalog_height; ?>px;width:<?php echo $catalog_width; ?>px;background: url(../images/banner.gif) repeat; "></div></td></tr><tr><td valign="top"><div class="inout-title"><a href="#" target="_blank"><?php echo $ad_title; ?></a></div><div class="inout-desc"><?php echo $d_description; ?></div></td></tr></table><?php 				}
				 ?></td></tr><?php
				}
				if($row['credit_text_positioning']==0 && $row['ctext'] !=0)
						echo $credittextpreview;
...
$singleflag=0;
	if($row['ad_type']==1 && $row['text_ad_type'] ==2)
		...
		?><table height="<?php   echo $blockheight;   ?>"  width="<?php  echo $row['width']; ?>" cellpadding="<?php  //if($row['scroll_ad']==0) echo "5"; else echo "0";  ?>0" cellspacing="0" class="inout-table"><?php 
		$textadblock="";
		$textadblockstart="";
		$textadblockend="";
		...
		if($row['orientaion']==2)//horizontal
			{
				...
				if($singleflag==1 && $row['credit_text_positioning']==2 && $row['ctext'] !=0)
				{
				...
				if($singleflag==1 && $row['credit_text_positioning']==3 && $row['ctext'] !=0)
				{
