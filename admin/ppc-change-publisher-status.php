...
if($action=="block")
{
	if(($name=="publisher" || $name=="demouser") && $script_mode=="demo")
	{
...
$login_path=$server_dir."ppc-publisher-login.php";
$body=str_replace("{PUB_LOGIN_PATH}",$login_path,$body);
?>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
   <td   colspan="4" scope="row" class="heading"><?php if($action=="block") { ?>
        Block Publisher<?php } else { ?> Activate Publisher<?php } ?></td>
  </tr>
</table>
<form action="ppc-change-publisher-status-action.php" method="post" enctype="multipart/form-data" name="form1">
