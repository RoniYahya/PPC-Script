...
$name=$mysql->echo_one("select username from ppc_publishers where uid=$pid");
	...
	if($name=="publisher" && $script_mode=="demo")
	{
		?>
		<br>
		<span class="already">You cannot block this user in demo. <a href="javascript:history.back(-1)">Back</a></span>
		<br><br>
...
<form action="ppc-send-block-mail.php" method="post" enctype="multipart/form-data" name="form1">
