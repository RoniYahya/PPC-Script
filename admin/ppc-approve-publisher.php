...
$body=str_replace("{PUB_LOGIN_PATH}",$server_dir."ppc-publisher-login.php",$body);
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
   <td   colspan="4" scope="row" class="heading">Approve Publisher</td>
  </tr>
</table>
 
<form action="ppc-approve-publisher-action.php" method="post" enctype="multipart/form-data" name="form1">
<input type="hidden" name="redirect" value="<?php echo $url; ?>" />
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  
  <tr>
    <td height="34" colspan="2"><span class="inserted">
    To complete approval action click the button below.
      </span></td>
    </tr>
  <tr>
