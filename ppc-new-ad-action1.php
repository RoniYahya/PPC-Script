...
{
//echo "haaaai";exit;
echo $beg_time=trim($_POST['beg_time']);
 echo $end_time=trim($_POST['end_time']); exit;
	phpSafe($beg_time);
	phpSafe($end_time);
...
mysql_query("INSERT INTO `ppc_ads` ( `id` , `uid` , `link` , `title` , `summary` , `maxamount` , `amountused` , `createtime` , `status` ,`adtype`,`displayurl`,`updatedtime`,`wapstatus`,`adlang`,`name`)
VALUES ('0', '$userid', '$url', '$title', '$summary', '$maxamount', '0', '".time()."', '-1','0','$displayurl','".time()."',$wap_flag,$adlang,'$adname')");
...
{
	//echo "insert into time_targeting values('0','$id','$sdate','$edate','0','0','0','0','$date_flg','0','0')";exit;
...
if($time_targeting==1)
{
//echo "insert into time_targeting values('0','$id','0','0','0','0','0','0','$date_flg','0','0')";
