...
$template->loadTemplate("publisher-templates/show-success.tpl.html");
...
if(isset($_GET['page']))
$template->setValue("{PAGE}","<a href=\"".$_GET['page']."\" class=\"pagetable_activecell\">Click here</a> to proceed.");
else
